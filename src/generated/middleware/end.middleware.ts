 ...
 */
export default function endMiddleware(context: Context, res: IResponse, logger: ILogger): void {
  const totalTimeInMS = context.startTime ? new Date().getTime() - context.startTime.getTime() : undefined;
